...
export const PrivatePolicy: React.FC = () => {
  return (
    <div className="mt-4">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to VenusAI.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to VenusAI, accessible from{" "}
            <a href="venus.chat" rel="external nofollow noopener" target="_blank">
              VenusAI.chat
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>By email: anonydev96@proton.me</li>
      </ul>
      <br />
      <br />
    </div>

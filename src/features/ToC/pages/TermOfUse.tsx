...
export const TermOfUse: React.FC = () => {
  return (
    <div className="mt-4">
      ...
      <br />
      <p>
        The VenusAI website located at venusai.chat is a copyrighted work belonging to VenusAI.
      ...
      <p>
        ...
        represent that you have the authority and capacity to enter into these Terms.&nbsp;YOU
      ...
      <p>
        <strong>Subject to these Terms.</strong> We grants you a non-transferable, non-exclusive,
      ...
      <p>
        <strong>No Support or Maintenance.</strong> You agree that we will have no obligation to
      ...
      <p>
        ...
        and its content are owned by We or We’s suppliers. Note that these Terms and access to the
        Site do not give you any rights, title or interest in or to any intellectual property
        rights, except for the limited access rights expressed in Section 2.1. We and its suppliers
        reserve all rights not granted in these Terms.
      </p>
      <br />
      <h2>User Content</h2>
      <p>
        <strong>User Content.</strong> "User Content" means any and all information and content that
        a user submits to the Site. You are exclusively responsible for your User Content. You bear
        ...
        others that your User Content is in any way provided, sponsored or endorsed by We. Because
        you alone are responsible for your User Content, you may expose yourself to liability. We is
      ...
      <p>
        ...
        harmful, invasive of another’s privacy, defamatory, false, intentionally misleading, trade
        libelous, pornographic involving minors, patently offensive, promotes racism, bigotry,
        hatred, or physical harm of any kind against any group or individual; (iii) that is harmful
        to minors in any way; or (iv) that is in violation of any law, regulation, or obligations or
      ...
      <p>
        If you provide We with any feedback or suggestions regarding the Site, you hereby assign to
        We all rights in such Feedback and agree that We shall have the right to use and fully
        exploit such Feedback and related information in any manner it believes appropriate.&nbsp;
        We will treat any Feedback you provide to We as non-confidential and non-proprietary.
      </p>
      <p>
        You agree to indemnify and hold We and its officers, employees, and agents harmless,
        ...
        violation of applicable laws or regulations or (d) your User Content. We reserves the right
        ...
        not to settle any matter without the prior written consent of We. We will use reasonable
      ...
      <p>
        ...
        own User Content.&nbsp; Because we do not control User Content, you acknowledge and agree
        that we are not responsible for any User Content, whether provided by you or by
        others.&nbsp; You agree that We will not be responsible for any loss or damage incurred as
        the result of any such interactions.&nbsp; If there is a dispute between you and any Site
        user, we are under no obligation to become involved.
      </p>
      <p>
        You hereby release and forever discharge the We and our officers, employees, agents,
      ...
      <p>
        <strong>Cookies and Web Beacons.</strong> Like any other website, VenusAI uses ‘cookies’.
      ...
      <h2>Disclaimers</h2>
      <p>
        The site is provided on an "as-is" and "as available" basis, and We and our suppliers
        ...
        for a particular purpose, title, quiet enjoyment, accuracy, or non-infringement.&nbsp; We
        and our suppliers make not guarantee that the site will meet your requirements, will be
        ...
        applicable law requires any warranties with respect to the site, all such warranties are
      ...
      <p>
        ...
        may not apply to you.&nbsp; Some jurisdictions do not allow limitations on how long an
        implied warranty lasts, so the above limitation may not apply to you.
      </p>
      <br />
      <h2>Limitation on Liability</h2>
      <p>
        To the maximum extent permitted by law, in no event shall We or our suppliers be liable to
        ...
        if We has been advised of the possibility of such damages.&nbsp; Access to and use of the
        site is at your own discretion and risk, and you will be solely responsible for any damage
      ...
      <p>
        ...
        full force and effect while you use the Site.&nbsp; We may suspend or terminate your rights
        to use the Site at any time for any reason at our sole discretion, including for any use of
        ...
        Content associated with your Account from our live databases.&nbsp; We will not have any
        liability whatsoever to you for any termination of your rights under these Terms.&nbsp; Even
        after your rights under these Terms are terminated, the following provisions of these Terms
        will remain in effect: Sections 2 through 2.5, Section 3 and Sections 4 through 10.
      </p>
      <br />
      <p>
        Indemnity. You will defend, indemnify, and hold harmless us, our affiliates, and our
      ...
      <p>
        Disclaimer. THE SERVICES ARE PROVIDED “AS IS.” EXCEPT TO THE EXTENT PROHIBITED BY LAW, WE
        AND OUR AFFILIATES AND LICENSORS MAKE NO WARRANTIES (EXPRESS, IMPLIED, STATUTORY OR
      ...
      <p>
        We respects the intellectual property of others and asks that users of our Site do the
        ...
        of our Site, unlawfully infringing the copyright(s) in a work, and wish to have the
      ...
      <p>
        ...
        be bound by the terms and conditions of such changes. Dispute Resolution. Please read this
        Arbitration Agreement carefully. It is part of your contract with We and affects your
        rights.&nbsp; It contains procedures for MANDATORY BINDING ARBITRATION AND A className
        ACTION WAIVER.
      </p>
      <p>
        <strong>Applicability of Arbitration Agreement.</strong> All claims and disputes in
        connection with the Terms or the use of any product or service provided by the We that
        ...
        Arbitration Agreement applies to you and the We, and to any subsidiaries, affiliates,
      ...
      <p>
        ...
        Notice to the We should be sent to our contact email. After the Notice is received, you and
        the We may attempt to resolve the claim or dispute informally.&nbsp; If you and the We do
      ...
      <p>
        ...
        conflict with the Terms.&nbsp; The AAA Consumer Arbitration Rules governing the arbitration
        ...
        $10,000.00) may be resolved through binding non-appearance-based arbitration, at the option
        of the party seeking relief.&nbsp; For claims or disputes where the total amount of the
        award sought is Ten Thousand U.S. Dollars (US $10,000.00) or more, the right to a hearing
        will be determined by the Arbitration Rules.&nbsp; Any hearing will be held in a location
        within 100 miles of your residence, unless you reside outside of the United States, and
        unless the parties agree otherwise.&nbsp; If you reside outside of the U.S., the arbitrator
        shall give the parties reasonable notice of the date, time and place of any oral hearings.
        Any judgment on the award rendered by the arbitrator may be entered in any court of
        competent jurisdiction.&nbsp; If the arbitrator grants you an award that is greater than the
        last settlement offer that the We made to you prior to the initiation of arbitration, the We
        will pay you the greater of the award or $2,500.00.&nbsp; Each party shall bear its own
      ...
      <p>
        ...
        initiating the arbitration.&nbsp; The arbitration shall not involve any personal appearance
        by the parties or witnesses unless otherwise agreed by the parties.
      </p>
      <p>
        <strong>Time Limits.</strong> If you or the We pursues arbitration, the arbitration action
      ...
      <p>
        ...
        decide the rights and liabilities of you and the We, and the dispute will not be
        ...
        based.&nbsp; The arbitrator has the same authority to award relief on an individual basis
        that a judge in a court of law would have.&nbsp; The award of the arbitrator is final and
        binding upon you and the We.
      </p>
      <p>
        ...
        the We in any state or federal court in a suit to vacate or enforce an arbitration award or
        otherwise, YOU AND THE We WAIVE ALL RIGHTS TO A JURY TRIAL, instead electing that the
        dispute be resolved by a judge.
      </p>
      <p>
        <strong>Waiver of className or Consolidated Actions.</strong> All claims and disputes within
        the scope of this arbitration agreement must be arbitrated or litigated on an individual
        basis and not on a className basis, and claims of more than one customer or user cannot be
      ...
      <p>
        ...
        termination of your relationship with We.
      </p>
      <p>
        <strong>Small Claims Court.</strong> Nonetheless the foregoing, either you or the We may
      ...
      <p>
        ...
        indirectly, any U.S. technical data acquired from We, or any products utilizing such data,
        in violation of the United States export laws or regulations.
      </p>
      <p>
        <strong>Electronic Communications.</strong> The communications between you and We use
        electronic means, whether you use the Site or send us emails, or whether We posts notices on
        the Site or communicates with you via email. For contractual purposes, you (a) consent to
        receive communications from We in an electronic form; and (b) agree that all terms and
        conditions, agreements, notices, disclosures, and other communications that We provides to
      ...
      <p>
        ...
        enforceable to the maximum extent permitted by law.&nbsp; Your relationship to We is that of
        ...
        delegated, or otherwise transferred by you without We’s prior written consent, and any
        attempted assignment, subcontract, delegation, or transfer in violation of the foregoing
        will be null and void.&nbsp; We may freely assign these Terms.&nbsp; The terms and

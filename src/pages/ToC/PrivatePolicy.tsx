export const PrivatePolicy: React.FC = () => {
  return (
    <div className="css-1vunpsv">
      <br />
      <br />
      <h2 className="chakra-heading css-1dklj6k">Privacy Policy</h2>
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Interpretation and Definitions</h2>
      <h2 className="chakra-heading css-18j379d">Interpretation</h2>
      <p className="chakra-text css-0">
        The words of which the initial letter is capitalized have meanings defined under the
        following conditions. The following definitions shall have the same meaning regardless of
        whether they appear in singular or in plural.
      </p>
      <h2 className="chakra-heading css-18j379d">Definitions</h2>
      <p className="chakra-text css-0">For the purposes of this Privacy Policy:</p>
      <ul>
        <li>
          <p className="chakra-text css-0">
        ...
        <li>
          <p className="chakra-text css-0">
            ...
            this Agreement) refers to PygmaChat.
          </p>
        </li>
        <li>
          <p className="chakra-text css-0">
            <strong>Cookies</strong> are small files that are placed on Your computer, mobile device
            or any other device by a website, containing the details of Your br/owsing history on
        ...
        <li>
          <p className="chakra-text css-0">
            <strong>Website</strong> refers to PygmaChat, accessible from{" "}
            <a href="PygmaChat.ai" rel="external nofollow noopener" target="_blank">
              PygmaChat.ai
            </a>
          </p>
        </li>
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Collecting and Using Your Personal Data</h2>
      <h2 className="chakra-heading css-18j379d">Types of Data Collected</h2>
      <h3>Personal Data</h3>
      <p className="chakra-text css-0">
      ...
      <ul>
        <li>
          <p className="chakra-text css-0">Email address</p>
        </li>
        <li>
          <p className="chakra-text css-0">Usage Data</p>
        </li>
      </ul>
      <h3>Usage Data</h3>
      <p className="chakra-text css-0">
      ...
      <p className="chakra-text css-0">
        ...
        address), br/owser type, br/owser version, the pages of our Service that You visit, the time
      ...
      <p className="chakra-text css-0">
        ...
        system, the type of mobile Internet br/owser You use, unique device identifiers and other
        diagnostic data.
      </p>
      <p className="chakra-text css-0">
        We may also collect information that Your br/owser sends whenever You visit our Service or
      ...
      <ul>
        <li>
          <strong>Cookies or br/owser Cookies.</strong> A cookie is a small file placed on Your
          Device. You can instruct Your br/owser to refuse all Cookies or to indicate when a Cookie
          is being sent. However, if You do not accept Cookies, You may not be able to use some
          parts of our Service. Unless you have adjusted Your br/owser setting so that it will
      ...
      <p className="chakra-text css-0">
        ...
        You close Your web br/owser. Learn more about cookies on the{" "}
        <a
      ...
      <ul>
        <li>
          ...
          <p className="chakra-text css-0">Type: Session Cookies</p>
          <p className="chakra-text css-0">Administered by: Us</p>
          <p className="chakra-text css-0">
        ...
        <li>
          ...
          <p className="chakra-text css-0">Type: Persistent Cookies</p>
          <p className="chakra-text css-0">Administered by: Us</p>
          <p className="chakra-text css-0">
      ...
      <h2 className="chakra-heading css-18j379d">Use of Your Personal Data</h2>
      <p className="chakra-text css-0">
      ...
      <h2 className="chakra-heading css-18j379d">Retention of Your Personal Data</h2>
      <p className="chakra-text css-0">
      ...
      <h2 className="chakra-heading css-18j379d">Transfer of Your Personal Data</h2>
      <p className="chakra-text css-0">
      ...
      <h2 className="chakra-heading css-18j379d">Delete Your Personal Data</h2>
      <p className="chakra-text css-0">
      ...
      <h2 className="chakra-heading css-18j379d">Disclosure of Your Personal Data</h2>
      ...
      <h2 className="chakra-heading css-18j379d">Security of Your Personal Data</h2>
      <p className="chakra-text css-0">
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Children's Privacy</h2>
      <p className="chakra-text css-0">
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Links to Other Websites</h2>
      <p className="chakra-text css-0">
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Changes to this Privacy Policy</h2>
      <p className="chakra-text css-0">
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Contact Us</h2>
      <p className="chakra-text css-0">
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul>
        <li>By email: contact@PygmaChat.ai</li>
      </ul>
      <br />
      <br />
    </div>

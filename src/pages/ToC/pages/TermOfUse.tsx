export const TermOfUse: React.FC = () => {
  return (
    <div>
      <h2 className="chakra-heading css-1dklj6k">Website Terms of Use</h2>
      <br />
      <p className="chakra-text css-0">Version 1.0</p>
      <br />
      <p className="chakra-text css-0">
        The PygmaChat website located at PygmaChat.ai is a copyrighted work belonging to PygmaChat.
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Access to the Site</h2>
      <p className="chakra-text css-0">
      ...
      <p className="chakra-text css-0">
        ...
        you.&nbsp; You approved that Company will not be held liable to you or any third-party for
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">User Content</h2>
      <p className="chakra-text css-0">
      ...
      <p className="chakra-text css-0">
        ...
        to indemnify us, and you agree to cooperate with our defense of these claims.&nbsp; You
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Third-Party Links &amp; Ads; Other Users</h2>
      <p className="chakra-text css-0">
      ...
      <p className="chakra-text css-0">
        ...
        others.&nbsp; You agree that Company will not be responsible for any loss or damage incurred
        as the result of any such interactions.&nbsp; If there is a dispute between you and any Site
      ...
      <p className="chakra-text css-0">
        <strong>Cookies and Web Beacons.</strong> Like any other website, PygmaChat uses ‘cookies’.
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Disclaimers</h2>
      <p className="chakra-text css-0">
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Limitation on Liability</h2>
      <p className="chakra-text css-0">
      ...
      <p className="chakra-text css-0">
        ...
        Content associated with your Account from our live databases.&nbsp; Company will not have
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Copyright Policy.</h2>
      <p className="chakra-text css-0">
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">General</h2>
      <p className="chakra-text css-0">
        ...
        Arbitration Agreement carefully. It is part of your contract with Company and affects your
      ...
      <p className="chakra-text css-0">
        ...
        Notice to the Company should be sent to our contact email. After the Notice is received, you
        and the Company may attempt to resolve the claim or dispute informally.&nbsp; If you and the
      ...
      <p className="chakra-text css-0">
        ...
        last settlement offer that the Company made to you prior to the initiation of arbitration,
        the Company will pay you the greater of the award or $2,500.00.&nbsp; Each party shall bear
        its own costs and disbursements arising out of the arbitration and shall pay an equal share
      ...
      <br />
      <h2 className="chakra-heading css-1dklj6k">Contact Information</h2>
      <p className="chakra-text css-0">Email: contact@PygmaChat.ai</p>
      <br />
      <br />
    </div>
  );
